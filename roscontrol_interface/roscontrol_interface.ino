...
CytronMD motor_left(PWM_PWM, 6, 7);   // PWM 1A = Pin 10, PWM 1B = Pin 11.
...
#define ENCRA 19 // BLACK
#define ENCRB 18 // WHITE
...
float count_per_rev_lm = 450.0;// <======== set this number according to your motor (count per rev) for left motor

float count_per_rev_rm = 450.0;// <======== set this number according to your motor (count per rev) for right motor
...
double LM_kp = 60, LM_ki = 40.0, LM_kd = 0.00000;          // modify for optimal performance
...
double RM_kp = 60, RM_ki = 40.0, RM_kd = 0.00000;          // modify for optimal performance
